...
<form id="rcp_registration_form" class="rcp_form" method="POST" action="<?php echo esc_url( rcp_get_current_url() ); ?>">
	...
	<!---------------------CUSTOMIZED INPUTS STARTS HERE!--------------------->
	
	<h3 class="rcp_header" style="font-weight: bold;">
		Contact Information
	</h3>
	<fieldset class="rcp_user_fieldset">
		<p id="rcp_contact_1_wrap">
			<label for="rcp_contact_1">Phone Number</label>
			<input name="rcp_contact_1" id="rcp_contact_1" class="required" type="text" <?php if( isset( $_POST['rcp_contact_1'] ) ) { echo 'value="' . esc_attr( $_POST['rcp_contact_1'] ) . '"'; } ?>/>
		</p>
		<p id="rcp_contact_2_wrap">
			<label for="rcp_contact_2">Your Address</label>
			<input name="rcp_contact_2" id="rcp_contact_2" class="required" type="text" <?php if( isset( $_POST['rcp_contact_2'] ) ) { echo 'value="' . esc_attr( $_POST['rcp_contact_2'] ) . '"'; } ?>/>
		</p>
		<p id="rcp_contact_3_wrap">
			<label for="rcp_contact_3">City, State, ZIP</label>
			<input name="rcp_contact_3" id="rcp_contact_3" class="required" type="text" <?php if( isset( $_POST['rcp_contact_3'] ) ) { echo 'value="' . esc_attr( $_POST['rcp_contact_3'] ) . '"'; } ?>/>
		</p>
	...
	<p>
	If this is a gift subscription, and you are paying on their behalf. Please enter their first and last name, as well as their email address below. You will receive billing information, and they will get free access.
	</p>
	<fieldset class="rcp_user_fieldset">
		<p id="rcp_gift_1_wrap">
			<label for="rcp_gift_1">First & Last Name</label>
			<input name="rcp_gift_1" id="rcp_gift_1" class="required" type="text" <?php if( isset( $_POST['rcp_gift_1'] ) ) { echo 'value="' . esc_attr( $_POST['rcp_gift_1'] ) . '"'; } ?>/>
		</p>
		<p id="rcp_gift_2_wrap">
			<label for="rcp_gift_2">Email</label>
			<input name="rcp_gift_2" id="rcp_gift_2" class="required" type="text" <?php if( isset( $_POST['rcp_gift_2'] ) ) { echo 'value="' . esc_attr( $_POST['rcp_gift_2'] ) . '"'; } ?>/>
		</p>
	</fieldset>

	<!---------------------CUSTOMIZED INPUTS ENDS HERE!--------------------->
	...
	<div class="rcp_gateway_fields">
		...
		if( count( $gateways ) > 1 ) :
			...
			<fieldset class="rcp_gateways_fieldset">
				<legend class="rcp_header"><?php _e( 'Choose Your Payment Method', 'rcp' ); ?></legend>
